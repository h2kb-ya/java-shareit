...
public class BookingController {
    ...
    public BookingDto getBookingByIdForBookerOrItemOwner(@RequestHeader(USER_ID_HEADER) Long userId,
    ...
    @GetMapping("/owner")
    public List<BookingDto> getBookingsForItemOwner(@RequestHeader(USER_ID_HEADER) long ownerId) {
        log.info("Request: GET /bookings/owner by owner {}", ownerId);

        return bookingMapper.toBookingDtoList(bookingService.getBookingsForItemOwner(ownerId));
    }
}
