...
public class ItemController {
    ...
    public ItemDto createItem(@RequestHeader(USER_ID_HEADER) long userId,
        ...
        return itemMapper.toItemDto(itemService.createItem(userId, item, createRequest.requestId()));
    }
    ...
    public CommentDto addComment(@RequestHeader(USER_ID_HEADER) long userId, @PathVariable long itemId,
